package com.burakonurerten.cityService.controller;


import com.burakonurerten.cityService.model.City;
import com.burakonurerten.cityService.service.CityService;
...
public class CityController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Void> getCity(@PathVariable String id,
